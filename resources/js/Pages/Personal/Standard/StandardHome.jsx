...
export default function StandardHome({ auth }) {
    return (
        ...
        <Head title="Ejercicios estándar" />
            <h1></h1>
            <div className="flex justify-around w-full p-10 pt-0 h-50 text-center text-zinc-200">
                <Link href='/espacio-personal/standard/busqueda' className="basis-1/2 rounded aspect-square m-5 bg-purple-500 flex flex-col justify-center items-center flex-wrap m-24">
                ...
                <Link href="/espacio-personal/standard/rutinas" className="basis-1/2 rounded aspect-square m-5 bg-purple-500 flex flex-col justify-center items-center flex-wrap m-24">
