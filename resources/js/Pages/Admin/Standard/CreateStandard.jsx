...
export default function CreateStandard({ auth }) {
    const categorias = ["Pierna", "Brazo", "Core", "Pecho", "Hombro", "Movilidad", "Flexibilidad"];
    ...
    function setUpData() {
        ...
        formulario.set('imagen', document.querySelector('#imagen').files[0]);
            ...
            <div className="text-center">
                ...
                <form encType="multipart/form-data">
                    <div className="flex flex-col w-screen h-auto p-10 pb-0 items-center justify-center">
                        ...
                        <div className="flex flex-col mb-3">
                            <label className="text-zinc-700 font-bold mb-3" htmlFor="category">Zona del cuerpo</label>
                        ...
                        <div className="flex flex-col">
                            <label className="text-zinc-700 font-bold mb-3" htmlFor="image">Imagen<span className="text-zinc-500 font-normal">{'(opcional)'}</span></label>
                            <input id="imagen" className="rounded border-zinc-300 w-60 h-9" type="file" accept="image/png, image/jpg, image/jpeg" name="imagen" />
                        </div>
                    </div>
