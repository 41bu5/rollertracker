...
export default function EditExerciseModal({ exercise, setShowModalEdit }) {
    ...
    function setUpData() {
        ...
        document.querySelector('#imagen').files[0] ? formulario.set('imagen', document.querySelector('#imagen').files[0]) : null;
            ...
            <form encType="multipart/form-data">
                    <div className="pl-20 pr-20">
                        ...
                        <div className="flex justify-center items-center mb-2">
                            <label className="text-zinc-700 font-bold mr-3 basis-1/4" htmlFor="image">Imagen<span className="text-zinc-500 font-normal">{'(opcional)'}</span></label>
                            <input id="imagen" className="rounded border-zinc-300 w-60 h-9 basis-3/4" type="file" accept="image/png, image/jpg, image/jpeg" name="imagen" />
                        </div>
                    </div>
